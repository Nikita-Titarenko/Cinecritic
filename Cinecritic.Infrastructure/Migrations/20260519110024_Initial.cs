        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCenturion = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikedDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieUsers_ApplicationUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    ApplicationUserId = table.Column<int>(type: "int", nullable: false),
                    InWatchListDateTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchLists", x => new { x.MovieId, x.ApplicationUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_MovieUsers_MovieUserId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "CreationDateTime", "DisplayName", "Email", "EmailConfirmed", "IsCenturion", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1000, 0, "3906ae6c-f560-495d-9a04-442d4e781053", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mykyta", "nikitatitarenko81@gmail.com", true, false, false, null, "NIKITATITARENKO81@GMAIL.COM", "NIKITATITARENKO81@GMAIL.COM", null, null, false, "f5b48743-a597-42e7-8d83-62af1a26ab5f", false, "nikitatitarenko81@gmail.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieUsers_ApplicationUserId",
                table: "MovieUsers",
